...
function DrawSprintBar()	// -- DEBUG SPRINT BAR
	local Sprint = LocalPlayer():Sprint()
	draw.RoundedBox( 4, 10, ScrH() - 100, 200, 40, Color(40, 40, 40, 50))
	if Sprint != 0 then
		draw.RoundedBox( 4, 10, ScrH() - 100, math.Clamp( Sprint, 0, 200) * 2, 40, Color( 220, 108, 108, 230) )
		draw.RoundedBox( 4, 10, ScrH() - 100, math.Clamp( Sprint, 0, 200) * 2, 40, Color( 225, 225, 225, 40) )
	end
	draw.DrawText( Sprint, "HPFont", 180, ScrH() - 90, Color( 0, 0, 0, 255), TEXT_ALIGN_RIGHT)
	draw.DrawText( "Sprint", "HPFont", 25, ScrH() - 90, Color( 0, 0, 0, 255), TEXT_ALIGN_LEFT)
end
function DrawWEPBar()
